...
#define WIRELESS_UART_TX_PIN       ( UART3_RX_P50 )    		// 无线串口对应模块的 TX 要接到单片机的 RX
#define WIRELESS_UART_RX_PIN       ( UART3_TX_P51 )    		// 无线串口对应模块的 RX 要接到单片机的 TX
#define WIRELESS_UART_RTS_PIN      ( IO_P42 )          		// 无线串口对应模块的 RTS 引脚
