...
//====================================================硬件 SPI 驱动====================================================	
	...
	#define IMU963RA_SPC_PIN            		( SPI2_CH1_SCLK_P67 )           // 硬件 SPI SCK 引脚
	#define IMU963RA_SDI_PIN            		( SPI2_CH1_MOSI_P65 )           // 硬件 SPI MOSI 引脚
	#define IMU963RA_SDO_PIN            		( SPI2_CH1_MISO_P66 )           // 硬件 SPI MISO 引脚
	#define IMU963RA_CS_PIN             		( IO_P64 )                      // CS 片选引脚
	#define IMU963RA_CS(x)              		( P64 = x )
//====================================================硬件 SPI 驱动====================================================
